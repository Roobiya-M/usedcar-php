...
if(isset($_POST['submit'])){
	...
	if(empty($city)||trim($city)==""){
		...
		echo "<span class='form-error'>Please accept terms and conditions !</span>";
		$errorterms=true;
	}else{
...
<script>
	...
	$("#city,#pincode,#mfgyear,#make,#model,#kms,#ownernos,#expprize,#terms").removeClass("input-error");
	...
	var errorterms="<?php echo($errorterms) ?>";
				 	...
				 	success:function(data){
				 		...
				 		if(data!=1){		 			
							...
							errorsell=true;
				 			 ...
				 			 window.location="../view/afposting.php";
				 		}
